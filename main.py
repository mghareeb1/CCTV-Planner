...
# إعداد حجم الشاشة للكمبيوتر فقط
...
# --- Helper: دالة لإنشاء العناوين المتوسطة ---
...
class StorageScreen(BaseScreen):
    def __init__(self, **kwargs):
        ...
        title = MDLabel(text="Storage Calculator", font_style="H6", theme_text_color="Custom", text_color="#ffffff", bold=True, halign="center", valign="center")
        toolbar.add_widget(back_btn)
        toolbar.add_widget(title)
        toolbar.add_widget(MDLabel(size_hint_x=None, width="40dp")) # Dummy for center balance
        
        # Inputs (Centered with size_hint_x=0.9)
        self.input_cameras = MDTextField(hint_text="Number of Cameras", input_filter="int", mode="rectangle", text_color_normal="#E0E0E0", text_color_focus="#00A8E8", hint_text_color_normal="#AAAAAA", size_hint_x=0.9, pos_hint={"center_x": .5})
        self.input_days = MDTextField(hint_text="Recording Days", input_filter="int", mode="rectangle", text_color_normal="#E0E0E0", text_color_focus="#00A8E8", hint_text_color_normal="#AAAAAA", size_hint_x=0.9, pos_hint={"center_x": .5})

        # Resolution Dropdown
        res_container = MDRelativeLayout(size_hint_y=None, height="60dp", size_hint_x=0.9, pos_hint={"center_x": .5})
        ...
        comp_container = MDRelativeLayout(size_hint_y=None, height="60dp", size_hint_x=0.9, pos_hint={"center_x": .5})
        ...
        # FPS Slider
        fps_layout = MDBoxLayout(orientation='vertical', spacing="5dp", size_hint_y=None, height="60dp", size_hint_x=0.9, pos_hint={"center_x": .5})
        self.lbl_fps = MDLabel(text="Frame Rate (FPS): 15", theme_text_color="Custom", text_color="#AAAAAA", font_style="Caption", halign="center")
        ...
        calc_btn = MDRaisedButton(text="CALCULATE STORAGE", md_bg_color="#00A8E8", text_color="#ffffff", size_hint_x=0.9, pos_hint={"center_x": .5}, elevation=2, padding="15dp", on_release=self.calculate)

        # Result Card
        self.result_card = MDCard(orientation='vertical', size_hint_y=None, height="120dp", padding="15dp", radius=[15], md_bg_color=[0.1, 0.1, 0.1, 0.6], elevation=0, size_hint_x=0.95, pos_hint={"center_x": .5})
...
class PowerScreen(BaseScreen):
    def __init__(self, **kwargs):
        ...
        toolbar = MDBoxLayout(size_hint_y=None, height="50dp", spacing="10dp")
        back_btn = MDIconButton(icon="arrow-left", theme_text_color="Custom", text_color="#ffffff", on_release=self.go_back)
        title = MDLabel(text="Power Center", font_style="H6", theme_text_color="Custom", text_color="#ffffff", bold=True, halign="center", valign="center")
        toolbar.add_widget(back_btn)
        toolbar.add_widget(title)
        toolbar.add_widget(MDLabel(size_hint_x=None, width="40dp"))

        # Inputs Centered
        self.input_cameras = MDTextField(hint_text="Number of Cameras", input_filter="int", mode="rectangle", text_color_normal="#E0E0E0", text_color_focus="#FFC107", hint_text_color_normal="#AAAAAA", size_hint_x=0.9, pos_hint={"center_x": .5})
        
        type_container = MDRelativeLayout(size_hint_y=None, height="60dp", size_hint_x=0.9, pos_hint={"center_x": .5})
        ...
        backup_container = MDRelativeLayout(size_hint_y=None, height="60dp", size_hint_x=0.9, pos_hint={"center_x": .5})
        ...
        switch_layout = MDBoxLayout(orientation='horizontal', size_hint_y=None, height="50dp", spacing="10dp", padding=[5,0], size_hint_x=0.9, pos_hint={"center_x": .5})
        lbl_switch = MDLabel(text="Warm Light Mode (+3W)", theme_text_color="Custom", text_color="#E0E0E0", font_style="Subtitle1", halign="center")
        ...
        calc_btn = MDRaisedButton(text="CALCULATE POWER", md_bg_color="#FFC107", text_color="#000000", size_hint_x=0.9, pos_hint={"center_x": .5}, elevation=2, padding="15dp", on_release=self.calculate)

        self.result_card = MDCard(orientation='vertical', size_hint_y=None, height="180dp", padding="15dp", radius=[15], md_bg_color=[0.1, 0.1, 0.1, 0.6], elevation=0, size_hint_x=0.95, pos_hint={"center_x": .5})
...
class CablingScreen(BaseScreen):
    def __init__(self, **kwargs):
        ...
        toolbar = MDBoxLayout(size_hint_y=None, height="50dp", spacing="10dp")
        back_btn = MDIconButton(icon="arrow-left", theme_text_color="Custom", text_color="#ffffff", on_release=self.go_back)
        title = MDLabel(text="Cable Check", font_style="H6", theme_text_color="Custom", text_color="#ffffff", bold=True, halign="center", valign="center")
        toolbar.add_widget(back_btn)
        toolbar.add_widget(title)
        toolbar.add_widget(MDLabel(size_hint_x=None, width="40dp"))
        
        # Inputs Centered
        cat_container = MDRelativeLayout(size_hint_y=None, height="60dp", size_hint_x=0.9, pos_hint={"center_x": .5})
        ...
        mat_container = MDRelativeLayout(size_hint_y=None, height="60dp", size_hint_x=0.9, pos_hint={"center_x": .5})
        ...
        self.input_len = MDTextField(hint_text="Cable Length (Meters)", input_filter="int", mode="rectangle", text_color_normal="#E0E0E0", text_color_focus="#4CAF50", hint_text_color_normal="#AAAAAA", size_hint_x=0.9, pos_hint={"center_x": .5})

        load_container = MDRelativeLayout(size_hint_y=None, height="60dp", size_hint_x=0.9, pos_hint={"center_x": .5})
        ...
        calc_btn = MDRaisedButton(text="CHECK VOLTAGE", md_bg_color="#4CAF50", text_color="#ffffff", size_hint_x=0.9, pos_hint={"center_x": .5}, elevation=2, padding="15dp", on_release=self.calculate)

        self.result_card = MDCard(orientation='vertical', size_hint_y=None, height="160dp", padding="15dp", radius=[15], md_bg_color=[0.1, 0.1, 0.1, 0.6], elevation=0, size_hint_x=0.95, pos_hint={"center_x": .5})
...
class LensScreen(BaseScreen):
    def __init__(self, **kwargs):
        ...
        toolbar = MDBoxLayout(size_hint_y=None, height="50dp", spacing="10dp")
        back_btn = MDIconButton(icon="arrow-left", theme_text_color="Custom", text_color="#ffffff", on_release=self.go_back)
        title = MDLabel(text="Lens Select", font_style="H6", theme_text_color="Custom", text_color="#ffffff", bold=True, halign="center", valign="center")
        toolbar.add_widget(back_btn)
        toolbar.add_widget(title)
        toolbar.add_widget(MDLabel(size_hint_x=None, width="40dp"))
        
        # Inputs Centered
        scene_container = MDRelativeLayout(size_hint_y=None, height="60dp", size_hint_x=0.9, pos_hint={"center_x": .5})
        ...
        self.input_dist = MDTextField(hint_text="Target Distance (Meters)", input_filter="float", mode="rectangle", text_color_normal="#E0E0E0", text_color_focus="#00BCD4", hint_text_color_normal="#AAAAAA", size_hint_x=0.9, pos_hint={"center_x": .5})
        self.input_width = MDTextField(hint_text="Target Width (Meters)", input_filter="float", mode="rectangle", text_color_normal="#E0E0E0", text_color_focus="#00BCD4", hint_text_color_normal="#AAAAAA", size_hint_x=0.9, pos_hint={"center_x": .5})
        ...
        calc_btn = MDRaisedButton(text="SUGGEST LENS", md_bg_color="#00BCD4", text_color="#ffffff", size_hint_x=0.9, pos_hint={"center_x": .5}, elevation=2, padding="15dp", on_release=self.calculate)
    ...
    def calculate(self, instance):
        try:
            ...
            self.res_lens.text = "Error"

# --- 5. IP Calculator Screen ---
class IPScreen(BaseScreen):
    def __init__(self, **kwargs):
        ...
        toolbar = MDBoxLayout(size_hint_y=None, height="50dp", spacing="10dp")
        back_btn = MDIconButton(icon="arrow-left", theme_text_color="Custom", text_color="#ffffff", on_release=self.go_back)
        title = MDLabel(text="IP Calculator", font_style="H6", theme_text_color="Custom", text_color="#ffffff", bold=True, halign="center", valign="center")
        toolbar.add_widget(back_btn)
        toolbar.add_widget(title)
        toolbar.add_widget(MDLabel(size_hint_x=None, width="40dp"))
        
        # Inputs Centered
        self.input_ip = MDTextField(text="192.168.1.1", hint_text="IP Address", mode="rectangle", text_color_normal="#E0E0E0", text_color_focus="#9C27B0", hint_text_color_normal="#AAAAAA", size_hint_x=0.9, pos_hint={"center_x": .5})
        
        cidr_container = MDRelativeLayout(size_hint_y=None, height="60dp", size_hint_x=0.9, pos_hint={"center_x": .5})
        ...
        calc_btn = MDRaisedButton(text="CALCULATE NETWORK", md_bg_color="#9C27B0", text_color="#ffffff", size_hint_x=0.9, pos_hint={"center_x": .5}, elevation=2, padding="15dp", on_release=self.calculate)

        # Result Card
        self.result_card = MDCard(orientation='vertical', size_hint_y=None, height="240dp", padding="15dp", radius=[15], md_bg_color=[0.1, 0.1, 0.1, 0.6], elevation=0, size_hint_x=0.95, pos_hint={"center_x": .5})
...
class HomeScreen(BaseScreen):
    ...
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        scroll = ScrollView(do_scroll_x=False)
        main_layout = MDBoxLayout(orientation='vertical', spacing="25dp", padding="20dp", size_hint_y=None, alignment=('center', 'top'))
        main_layout.bind(minimum_height=main_layout.setter('height'))

        header = MDBoxLayout(orientation='vertical', size_hint_y=None, height="160dp", spacing="10dp", padding="10dp", pos_hint={"center_x": .5})
        ...
        # Centered Grid
        grid_container = MDBoxLayout(orientation='vertical', size_hint_y=None, adaptive_height=True, padding=[0, 0, 0, 0])
        grid = MDGridLayout(cols=2, spacing="15dp", size_hint_y=None, adaptive_height=True, size_hint_x=None, width="325dp", pos_hint={"center_x": .5})
        ...
        grid.add_widget(DashboardCard("IP Calculator", "calculator", "#9C27B0", screen_name="ip"))
        grid_container.add_widget(grid)

        footer_layout = MDBoxLayout(orientation='vertical', size_hint_y=None, height="100dp", spacing="15dp", pos_hint={"center_x": .5})
